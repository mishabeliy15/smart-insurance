...
class CreateCompanyPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      min_price: 400,
      max_price: 3000,
      percent_over_speeding: 10,
      min_speed_commit_rotate_head: 60,
      percent_head_rotate_for_hour: 5,
      max_speed_discount: 400,
  ...
  handleOnSubmit = (event) => {
    ...
    dispatch(createCompany(this.state)).then(() => history.push("/companies"));
  };
...
export default connect(mapStateToProps)(
  withStyles(useStyles)(withNamespaces()(CreateCompanyPage))
);
