...
def get_horizontal_angle(img, annotate_image=True) -> Tuple[int, np.ndarray]:
    size = img.shape
    ...
    for face in faces:
        ...
        try:
            ...
            horizontal_angle = int(math.degrees(math.atan(-1 / m)))
        except:
            horizontal_angle = 90
